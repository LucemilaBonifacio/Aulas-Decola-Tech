...
--Exercícios
/*
  1. Na tabela TB_CARGOS, adicionar uma restrição impedindo que
     o salário seja negativo, ou igual a zero(>0)

  2. Na tabela TB_CANDIDATOS, o email deve ser único (exclusivo) - UNIQUE
  
  3. Não deve ser permitido um candidato se inscreva em uma vaga mais de uma vez.
*/
